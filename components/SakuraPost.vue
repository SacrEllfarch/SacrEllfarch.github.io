...
import SakuraPostAuthorAside from './SakuraPostAuthorAside.vue'
...
.sakura-post {
  ...
  .sakura-triple-columns {
    @include screen('md') {
      grid-template-columns: 170px minmax(0, 800px) 150px !important;
    }

    @include screen('lg') {
      grid-template-columns: 260px minmax(0, 800px) 250px !important;
    }
  }
}
</style>
